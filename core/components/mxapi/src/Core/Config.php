 ...
 *
 * @api Вызывается провайдерами; наследование не поддерживается.
 */
class Config
{
    /** @var array */
    ...
    private static $defaults = [
        ...
        // Ключ подписи курсоров постраничного обхода. Генерируется при установке
        // пакета; пустое значение выключает курсорную пагинацию, а не разрешает
        // её без подписи.
        'cursor_secret' => '',
        'trusted_proxies' => [],
        'providers' => [],
