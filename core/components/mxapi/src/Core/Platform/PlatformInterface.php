 ...
 *
 * @api Вызывается провайдерами через EndpointContext::getPlatform().
 *      Реализовывать НЕ следует: адаптеры платформы поставляет сам пакет, и
 *      состав интерфейса растёт вместе с ядром без смены мажорной версии.
 */
