...
<template>
  <div class="mxapi-clients">
    <Toast />
    <ConfirmPopup />

    <p class="mxapi-intro">{{ t('mxapi_client_intro') }}</p>

    <div class="mxapi-actions">
      <Button :label="t('mxapi_client_create')" icon="pi pi-plus" @click="openCreate" />
    </div>

    <Message v-if="error" severity="error" :closable="false">{{ error }}</Message>

    <DataTable :value="clients" :loading="loading" data-key="id" class="mxapi-grid">
      <template #empty>{{ t('mxapi_client_empty') }}</template>
        ...
        <template #body="{ data }">
          <div class="mxapi-row-actions">
            <Button
              ...
              severity="secondary"
              text
              v-tooltip.top="t('mxapi_client_edit')"
              @click="openEdit(data)"
            />
            <Button
              icon="pi pi-refresh"
              severity="secondary"
              text
              v-tooltip.top="t('mxapi_client_regenerate')"
            ...
            <Button
              ...
              severity="secondary"
              text
              v-tooltip.top="data.active ? t('mxapi_client_deactivate') : t('mxapi_client_activate')"
            ...
            <Button
              ...
              severity="danger"
              text
              v-tooltip.top="t('mxapi_client_remove')"
